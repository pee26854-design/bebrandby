...
export default function Account() {
    ...
    async function loadData() {
      try {
        ...
        const [profileRes, addressRes, ordersRes] = await Promise.allSettled([
          fetchJsonWithTimeout(`${API_BASE}/users/me`, { headers }),
          fetchJsonWithTimeout(`${API_BASE}/users/me/addresses`, { headers }),
          fetchJsonWithTimeout(`${API_BASE}/orders/me`, { headers }),
        ]);
  ...
  async function removeAddress(id) {
    await fetch(`${API_BASE}/users/me/addresses/${id}`, {
      method: "DELETE",
