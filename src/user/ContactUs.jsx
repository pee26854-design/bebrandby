    ...
    <div className="min-h-screen p-6 bg-gray-50">
      <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <aside className="lg:col-span-1 bg-white rounded-lg p-6 border shadow-md">
          <h2 className="text-sm font-semibold mb-1 text-black-700">ติดต่อเรา</h2>
          <p className="text-sm text-pink-700">สอบถามข้อมูลสินค้า / การสั่งซื้อ / การชำระเงิน</p>

          <div className="text-sm space-y-3">
            <div>
              <div className="font-medium text-black-700">ที่อยู่</div>
              <div className="text-pink-700">123/4 ถนนสุขุมวิท กรุงเทพฯ 10110</div>
            </div>

            <div>
              <div className="font-medium text-black-700">เบอร์โทร</div>
              <div><a href="tel:0812345678" className="text-pink-600 font-medium">081-234-5678</a></div>
            </div>

            <div>
              <div className="font-medium text-black  -700">อีเมล</div>
